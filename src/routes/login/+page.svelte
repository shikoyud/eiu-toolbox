...
<div class="w-80 mt-10">
	<details class="collapse bg-base-100 border border-base-300" name="login-accordion" open>
		...
		<div class="collapse-content text-sm font-inter">
			...
			<a class="link link-primary" href="https://aao.eiu.edu.vn/">https://aao.eiu.edu.vn/</a>
		</div>
	</details>
	...
	<details class="collapse bg-base-100 border border-base-300" name="login-accordion">
		...
		<div class="collapse-content text-sm font-inter">
			You can inspect the <a class="link link-primary" href="https://github.com/shikoyud/eiu-toolbox">source code</a> on GitHub. There is no no tracking, and no code that sends your credentials anywhere except the official school API.
		</div>
	</details>
</div>
